...
body:before {
  ...
  content: "Error: File to import not found or unreadable: vars.\A        Load paths:\A          \A         on line 1 of index.scss\A \A 1: @import 'vars';\A 2: @import 'colorBlue';\A 3: \A 4: body {\A 5:   background: $color;\A 6:   color: colorBlue();"; }
